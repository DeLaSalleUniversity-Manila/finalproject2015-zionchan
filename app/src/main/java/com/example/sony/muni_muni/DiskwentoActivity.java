...
public class DiskwentoActivity extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_diskwento);
        ...
        answerbutton.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                String correctAnswer = "diskwento";

                if (correctAnswer.equalsIgnoreCase(str)) {
                    Toast.makeText(DiskwentoActivity.this, "Correct!", Toast.LENGTH_SHORT).show();

                    finish();
                } else {
                    Toast.makeText(DiskwentoActivity.this, "Wrong!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btnOpenPopup1.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                View popupView1 = layoutInflater1.inflate(R.layout.diskwento_definition_popup, null);
        ...
        btnOpenPopup2.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                View popupView2 = layoutInflater2.inflate(R.layout.diskwento_singkahulugan_popup, null);
