...
public class AbotActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        answerbutton.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                String correctAnswer = "abot";

                if (correctAnswer.equalsIgnoreCase(str)) {
                    Toast.makeText(AbotActivity.this, "Correct!", Toast.LENGTH_SHORT).show();

                        finish();
                }
                else
                {
                    Toast.makeText(AbotActivity.this, "Wrong!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btnOpenPopup1.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                View popupView1 = layoutInflater1.inflate(R.layout.abot_definition_popup, null);
        ...
        btnOpenPopup2.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                View popupView2 = layoutInflater2.inflate(R.layout.abot_singkahulugan_popup, null);
