...
public class PambahayActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pambahay);
        ...
        answerbutton.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                String correctAnswer = "pambahay";

                if (correctAnswer.equalsIgnoreCase(str)) {
                    Toast.makeText(PambahayActivity.this, "Correct!", Toast.LENGTH_SHORT).show();

                    finish();
                } else {
                    Toast.makeText(PambahayActivity.this, "Wrong!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btnOpenPopup1.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                View popupView1 = layoutInflater1.inflate(R.layout.pambahay_definition_popup, null);
        ...
        btnOpenPopup2.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                View popupView2 = layoutInflater2.inflate(R.layout.pambahay_singkahulugan_popup, null);
