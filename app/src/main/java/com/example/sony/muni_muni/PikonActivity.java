...
public class PikonActivity extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pikon);
        ...
        answerbutton.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                String correctAnswer = "pikon";

                if (correctAnswer.equalsIgnoreCase(str)) {
                    Toast.makeText(PikonActivity.this, "Correct!", Toast.LENGTH_SHORT).show();

                    finish();
                } else {
                    Toast.makeText(PikonActivity.this, "Wrong!", Toast.LENGTH_SHORT).show();
                }
            }
        });
