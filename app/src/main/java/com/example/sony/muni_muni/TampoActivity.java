...
public class TampoActivity extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tampo);
        ...
        answerbutton.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                String correctAnswer = "tampo";

                if (correctAnswer.equalsIgnoreCase(str)) {
                    Toast.makeText(TampoActivity.this, "Correct!", Toast.LENGTH_SHORT).show();

                    finish();
                } else {
                    Toast.makeText(TampoActivity.this, "Wrong!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btnOpenPopup1.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                View popupView1 = layoutInflater1.inflate(R.layout.tampo_definition_popup, null);
        ...
        btnOpenPopup2.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                View popupView2 = layoutInflater2.inflate(R.layout.tampo_singkahulugan_popup, null);
